...
- (void)viewDidLoad {
    ...
    _pswImgView1 = [[UIImageView alloc] initWithFrame:CGRectMake(15, 15, 30, 30)];
    ...
    _pswImgView2 = [[UIImageView alloc] initWithFrame:CGRectMake(15, 75, 30, 30)];
    ...
    _pswImgView3 = [[UIImageView alloc] initWithFrame:CGRectMake(15, 135, 30, 30)];
    [self.view addSubview:_pswImgView3];
    _pswImgView3.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"mima@2x" ofType:@"png"]];
    
    _pswField1 = [[UITextField alloc] initWithFrame:CGRectMake(70, 20, 180, 30)];
    ...
    _horizontalMark2 = [[UIView alloc] initWithFrame:CGRectMake(5, 120, frame.size.width-10, 0.5)];
    [self.view addSubview:_horizontalMark2];
    _horizontalMark2.backgroundColor = [UIColor lightGrayColor];
    
    _pswField2 = [[UITextField alloc] initWithFrame:CGRectMake(70, 80, 180, 30)];
    ...
    _pswField3 = [[UITextField alloc] initWithFrame:CGRectMake(70, 140, 180, 30)];
    ...
    _horizontalMark3 = [[UIView alloc] initWithFrame:CGRectMake(5, 180, frame.size.width-10, 0.5)];
    ...
    _btnConfirm.frame = CGRectMake(5, 210, frame.size.width-10, 35);
